    ...
    <div class="content">
        ...
        <div class="btn-deposit">
            ...
            <template v-if="currentStep === step.payment">
                ...
                <button type="button" class="btn-payment">Xác nhận</button>
            </template>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState('depositStore', ['methodSelected'])
        }
    }
</script>
...
<style>
    ...
    .btn-deposit .btn-method {
        width: 95%;
    }
    .btn-deposit .btn-payment {
        width: 47%;
    }
    .disabled {
    ...
    .note span {
        display: block;
        border-bottom: 1px solid #c0c5ce45;
        padding: 10px 20px;
    }
</style>
